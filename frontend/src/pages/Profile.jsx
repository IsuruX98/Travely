  ...
  return (
    <>
      <div className="grid lg:grid-cols-2 gap-8 md:px-24 p-4 sm:py-8">
        <div className="flex flex-col justify-center items-center md:py-24 py-10 gap-5 rounded-lg bg-white p-6 shadow-md">
          <div>
            <img
        ...
        <div className="flex flex-col justify-center items-start gap-5 xl:pl-20 rounded-lg bg-white p-6 shadow-md">
